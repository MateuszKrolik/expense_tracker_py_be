...
async def set_offline_budgets_batch(
    ...
    return await create_offline_budgets_batch(
        session=session, budgets_base=budgets_base
    )
...
async def set_budget_for_month(
    ...
    return await set_budget_for_given_month(session=session, budget_base=budget_base)
...
async def get_budget_for_month(
    ...
    return await get_budget_for_given_month(session=session, year=year, month=month)
